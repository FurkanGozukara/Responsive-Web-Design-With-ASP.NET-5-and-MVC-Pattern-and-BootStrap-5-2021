...
namespace lecture_9
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // app.UseResponseCompression(); use this only if you dont have server side compression such as iis compression
            app.UseResponseCaching();

            //for response cache to work these conditions have to be satisfied : https://stackoverflow.com/a/59192536
